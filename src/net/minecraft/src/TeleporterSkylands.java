...
public class TeleporterSkylands extends Teleporter {
    ...
    public boolean func_4106_b(World var1, Entity var2) {
        ...
        for(int var11 = var9 - var3; var11 <= var9 + var3; ++var11) {
            ...
            for(int var14 = var10 - var3; var14 <= var10 + var3; ++var14) {
                ...
                for(int var17 = 128 - 1; var17 >= 0; --var17) {
                    if(var1.getBlockId(var11, var17, var14) == mod_SkylandsPortal.skylandsPortal.blockID) {
                        while(var1.getBlockId(var11, var17 - 1, var14) == mod_SkylandsPortal.skylandsPortal.blockID) {
                            --var17;
                        }
        ...
        if(var4 >= 0.0D) {
            ...
            if(var1.getBlockId(var6 - 1, var7, var8) == mod_SkylandsPortal.skylandsPortal.blockID) {
                var22 -= 0.5D;
            }
            ...
            if(var1.getBlockId(var6, var7, var8 - 1) == mod_SkylandsPortal.skylandsPortal.blockID) {
                var18 -= 0.5D;
            }
                            ...
                            for(var24 = 0; var24 < 3; ++var24) {
                                for(var25 = 0; var25 < 4; ++var25) {
                                    for(var26 = -1; var26 < 4; ++var26) {
                                        ...
                                        if(var26 < 0 && !this.blockIsGood(var1.getBlockId(var27, var28, var29))) {
                                            continue label296;
                                        }
                                    }
                                }
                            ...
                            for(var21 = var13; var21 < var13 + 2; ++var21) {
                                ...
                                for(var24 = 0; var24 < 4; ++var24) {
                                    for(var25 = -1; var25 < 4; ++var25) {
                                        ...
                                        if(var25 < 0 && !this.blockIsGood(var1.getBlockId(var26, var27, var28))) {
                                            continue label234;
                                        }
                                    }
                                }
            ...
            for(var20 = -1; var20 <= 1; ++var20) {
                for(var21 = 1; var21 < 3; ++var21) {
                    for(var22 = -1; var22 < 3; ++var22) {
                        ...
                        var34 = var22 < 0;
                        var1.setBlockWithNotify(var23, var24, var25, var34 ? Block.blockGold.blockID : 0);
                    }
                }
            }
        }
        ...
        for(var20 = 0; var20 < 4; ++var20) {
            ...
            for(var21 = 0; var21 < 4; ++var21) {
                for(var22 = -1; var22 < 4; ++var22) {
                    ...
                    var1.setBlockWithNotify(var23, var24, var25, var34 ? Block.blockGold.blockID : mod_SkylandsPortal.skylandsPortal.blockID);
                }
            }
    ...
    public boolean blockIsGood(int blockId) {
        if (blockId == 0) {
            return false;
        }

        return Block.blocksList[blockId].renderAsNormalBlock() && Block.blocksList[blockId].isOpaqueCube();
    }
}
